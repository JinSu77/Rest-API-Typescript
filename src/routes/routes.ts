...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsFilmController_readUser: Record<string, TsoaRoute.ParameterSchema> = {
                id: {"in":"path","name":"id","required":true,"dataType":"double"},
        };
        app.get('/film/:id',
            ...(fetchMiddlewares<RequestHandler>(FilmController)),
            ...(fetchMiddlewares<RequestHandler>(FilmController.prototype.readUser)),

            async function FilmController_readUser(request: ExRequest, response: ExResponse, next: any) {
